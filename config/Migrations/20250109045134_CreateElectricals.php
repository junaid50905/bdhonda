...
class CreateElectricals extends BaseMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('electricals');
        $table->addColumn('product_id', 'integer', ['null' => false])
            ->addColumn('battery', 'string', ['limit' => 100, 'null' => true, 'default' => null])
            ->addColumn('head_lamp', 'string', ['limit' => 100, 'null' => true, 'default' => null])
