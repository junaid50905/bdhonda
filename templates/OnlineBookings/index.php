        ...
        <div class="locator-sec">
            <div class="row p-3" style="justify-content: center;">
                ...
                <div class="col-md-8 col-sm-6 col-xs-12">
                    ...
                    <?php echo $this->Form->create(null, ['controller' => 'OnlineBookings', 'action' => 'index', $productDetails->slug]); ?>
                    <div class="form-left-box rech-us-box">
                        <div class="text-center">
                            <h3><?php echo $productDetails['name'] ?> Online Booking form</h3>
                        </div>
                        <br>
                        ...
                        <div class="form-inline row g-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <?php echo $this->Form->input(
                                        'date_time',
                                        array('class' => 'form-control', 'type' => 'datetime-local', 'label' => false, 'placeholder' => 'Date and time', 'required' => true)
                                    ); ?>
                                </div>
                            </div>
