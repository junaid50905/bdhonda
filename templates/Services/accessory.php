    ...
    <section class="micro-sec network-sec">
        <div class="network-header">
            <div class="row">
                ...
                <ul class="menu-network col-md-8 col-sm-12 col-xs-12">
                    <li><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/honda-service">Honda Service</a></li>
                    <li><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/maintenance">Maintenance</a></li>
                    <li><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/warranty">Warranty</a></li>
                    <li><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/genuine-parts">Genuine Parts</a></li>
                    <li><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/engine-oil">Engine Oil</a></li>
                    <li><a class="menu-network-active"
                            href="<?= $this->Url->build('/', ['fullBase' => true]); ?>services/accessory">Accessory</a>
                    </li>
                    <!--                <li><a href="-->
                ...
                <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/services/honda-service.jpg" alt="">
                <ol class="breadcrumb m-l-brad">
                    <li class="breadcrumb-item"><a href="<?= $this->Url->build('/', ['fullBase' => true]); ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="../services/honda-service">Services</a></li>
        ...
        <div class="locator-sec Campaign-sec">
            ...
            <div class="col-md-12 p-3">
                <div id="exTab1" class="">
                    <ul class="nav nav-pills nab-tabs tabb-design" id="nav-tab" role="tablist">
                        <li id="li1" class="nav-link active" id="nav-helmet-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-helmet" type="button" role="tab" aria-controls="nav-helmet"
                            aria-selected="true"><a href="#1a" data-toggle="tab">Helmet</a></li>
                        <li id="li2" class="nav-link" id="nav-front-pipe-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-front-pipe" type="button" role="tab" aria-controls="nav-front-pipe"
                            aria-selected="true"><a href="#2a" data-toggle="tab">Front Pipe</a></li>
                        <li id="li3" class="nav-link" id="nav-liquid-item-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-liquid-item" type="button" role="tab" aria-controls="nav-liquid-item"
                            aria-selected="true"><a href="#3a" data-toggle="tab">Liquid Item</a></li>
                        <li id="li4" class="nav-link" id="nav-other-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-other" type="button" role="tab" aria-controls="nav-other"
                            aria-selected="true"><a href="#4a" data-toggle="tab">Other Items</a></li>
                    </ul>
                    <div class="tab-content p-3 border bg-light clearfix" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="nav-helmet" role="tabpanel"
                            aria-labelledby="nav-helmet-tab">
                            <!--                            <div class="col-sm-12">-->
                                ...
                                <div class="rightSidebarPro">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    ...
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/1.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Pearl Black </p>
                                                    </div>
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/2.png"
                                                        alt="Lights" style="width:100%">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="pri-chart">
                                                <h4>MONSOON GREY Retail Price :<span>BDT 2,800</span>(Including Vat)
                                                </h4>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/MONSOON_GREY.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>MONSOON GREY</p>
                                                    </div>
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/PEARL_BLACK.png"
                                                        alt="Lights" style="width:100%">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/8.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Pearl Red</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/RED.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>RED</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/BASIC_BLACK.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>BASIC BLACK</p>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    ...
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/BLACK.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>BLACK</p>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    ...
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/BROWN.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>BROWN</p>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    ...
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/5.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Deep Blue</p>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    ...
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/9.png"
                                                        alt="Lights" style="width:80%">
                                                    <div class="caption">
                                                        <p>Light Blue</p>
                                                    </div>
                                                    </a>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/10.HALF FACE Sports Red (SP15M-HEL900SREX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Sports Red</p>
                                                    </div>
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/11.HALF FACE Sports Black (SP15M-HEL900BLEX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Black</p>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/6.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Orange White</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/7.png"
                                                        <img
                                                        src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13.FULL FACE  Space Black (SP3XL-HEL-900BKEX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Black</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/SPACESILVER.png"
                                                        <img
                                                        src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13.FULL FACE  Space Black (SP3XL-HEL-900BKEX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/1.Pink.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Pink</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/2.Marvel Blue.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Marvel Blue</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/3.SpartanRed.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Spartan Red</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/4.IgneousBlack.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Igneous Black</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/5.Red&Black.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>Red & Black</p>
                                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/SKYBLUE.png"
                                                        <img
                                                        src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13.FULL FACE  Space Black (SP3XL-HEL-900BKEX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02">
                                                <div class="thumbnail-st-s">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/SILVER0.png"
                                                        <img
                                                        src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13.FULL FACE  Space Black (SP3XL-HEL-900BKEX).png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-02" style="width: 49%">
                                                <div class="thumbnail-st">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/BLACK.0.png"
                                                        alt="Lights" style="width:100%">
                                                    <div class="caption">
                                                        <p>BLACK</p>
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="nav-front-pipe" role="tabpanel"
                            aria-labelledby="nav-front-pipe-tab">
                            <div class="col-sm-12">
                                <div class="rightSidebarPro">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/2Picture.png"
                                                            alt="Lights" style="width:100%; margin-top: 75px;">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/1Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                                        <div class="caption">
                                            ...
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-001">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/3Picture.png"
                                                            alt="Lights" style="margin-top: 50px; height: 40%">
                                                ...
                                                <div class="box-001">
                                                    <div class="thumbnail-stn-img">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/4Picture.png"
                                                            alt="Lights" style="height: 250px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/5Picture.png"
                                                            alt="Lights" style="margin-top: 50px; height: 38%">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/6Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/7Picture.png"
                                                            alt="Lights" style="margin-top: 50px; height: 38%">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/8Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/9Picture.png"
                                                            alt="Lights" style="width:100%; margin-top: 50px;">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/10Picture.png"
                                                            alt="Lights" style="width:100%">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Long-Lasting Durability</li>
                                                    <li>Stylish Design</li>
                                                    <li>Specially Designed for <b>Shine SP</b> and <b>CB Shine</b>
                                                        Motorcycle</li>
                                                </ul>
                                            ...
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/11Picture.png"
                                                            alt="Lights" style="width:100%; margin-top: 50%;">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-sts">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/12Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->

                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13Picture.png"
                                                            alt="Lights" style="height: 200px; width: 270px">
                                                    </div>

                                                    <div class="thumbnail-sts">
                                                        <!-- <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/13Picture.png" alt="Lights" style="height: 200px; width: 250px"> -->
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/14Picture.png"
                                                            alt="Lights" style="width:85%; margin-top: 50px;">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/15Picture.png"
                                                            alt="Lights" style="width:100%">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Long-Lasting Durability</li>
                                                    <li>Stylish Design</li>
                                                    <li>Specially Designed for <b>Dream 110</b> and <b>Livo</b>
                                                        Motorcycle</li>
                                                </ul>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/16Picture.png"
                                                            alt="Lights" style="width:80%; margin-top: 50%;">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-sts">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/17Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/18Picture.png"
                                                            alt="Lights" style="height: 200px; width: 270px">
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mt-2 mb-5">
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/19Picture.png"
                                                            alt="Lights" style="margin-top: 95px; height: 40%">
                                                        <div class="caption">
                                                            <!--<p>Pearl Black </p>-->
                                                        </div>
                                                        </a>
                                                ...
                                                <div class="box-01">
                                                    <div class="thumbnail-stn">
                                                        <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/20Picture.png"
                                                            alt="Lights" style="height: 200px; width: 250px">
                                                        <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                            ?>
                                                        <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                        ...
                        <div class="tab-pane fade" id="nav-liquid-item" role="tabpanel"
                            aria-labelledby="nav-liquid-item-tab">
                            <div class="col-sm-12">
                                <div class="rightSidebarPro">
                                    ...
                                    <div class="row pt-2 pb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <ul>
                                                <li>Honda chain cleaner and lube Specially formulated for all Honda
                                                    Motorcycle.</li>
                                                <li>Effectively cleans and lubricates, removing dirt and mud to ensure
                                                    optimal performance and longevity.</li>
                                                <li>Prevents corrosion, extending the lifespan of your chain and
                                                    sprockets, allowing for a smoother ride.</li>
                                                <li>The specialized oil formula penetrates deeply into chain components,
                                                    providing an even and durable lubrication layer to minimize
                                                    friction.</li>
                                                <li>Convenient spray design for effortless application without
                                                    disassembly, making maintenance quick and hassle-free.</li>
                                                <li>Size 400ml.</li>
                                            </ul>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-stn">
                                                    <img class='speard'
                                                        src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/21Picture.jpg"
                                                        alt="Lights" style="height: 135%;">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                                    <div class="caption">
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="box-01">
                                                <div class="thumbnail-stn">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/2.HALF FACE Pearl Black (SP1LL-HEL-901PB).png" alt="Lights" style="width:100%">-->
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/23Picture.png"
                                                        alt="Lights" style=" height: 100%; margin-top: 30px">
                                                    <div class="caption">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-stn">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/22Picture.png"
                                                        alt="Lights" style=" height: 110%">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                                    &nbsp;
                                    ...
                                    <div class="row pt-2 pb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <ul>
                                                ...
                                                <li>Maintains lubricity and fluidity across various driving conditions,
                                                    ensuring reliable braking.</li>
                                                <li>Can be easily topped off during maintenance and is compatible with
                                                    most brake systems designed for DOT 3 fluid.</li>
                                                <li>Made from premium components to provide superior protection and
                                                    performance compared to generic fluids.</li>
                                                <li>Ensures consistent braking performance, crucial for motorcycle
                                                    safety.</li>
                                            </ul>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-stn">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/24Picture.png"
                                                        alt="Lights" style="height: 100%;">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                                    <div class="caption">
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-stn">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/25Picture.png"
                                                        alt="Lights" style="height: 100%;">
                                                    <!--                                                <img src="--><?php //echo Router::url('/', true);
                                                                                                                        ?>
                                                    <!--assets/public/images/accessory/9.HALF FACE Space Silver (SP1XL-HEL901SS).png" alt="Lights" style="width:100%">-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/emblem_dream_neo_r.jpg"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/key_ring.png"-->
                            ...
                            <div class="col-sm-12">
                                <div class="rightSidebarPro">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-jkt">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Jacket-Front.png"
                                                        alt="Lights"
                                                        style="width:95%; margin-left: 20px; margin-top:12px">
                                                </div>

                                                <div class="jkt-content">
                                                    <p
                                                        style="font-size: 16px; text-align: center; line-height: 22px; margin: 0 0 5px;">
                                                        Front</p>
                                                </div>
                                            ...
                                            <div class="box-01">
                                                <div class="thumbnail-jkt">
                                                    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Jacket Back.png"
                                                        alt="Lights"
                                                        style="width:90%; height:265px; margin-left: 10px;">
                                                    &nbsp;
                                                </div>
                                                <div class="jkt-content">
                                                    <p
                                    ...
                                    <div class="row pt-2 pb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <ul>
                                                ...
                                                <li>Features the iconic Honda logo prominently, showcasing brand
                                                    loyalty.</li>
                                                <li>Equipped with a sturdy metal keyring that easily attaches to keys,
                                                    bags, or other accessories.</li>
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/26Picture.png"
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/27Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    <!-------------------new model added---------------->
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/28Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/29Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/30Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    ...
                                    <div class="row pt-2 pb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/31Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                    ...
                                    <div class="row pt-2 pb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <h5>Specification</h5>
                                            <ul>
                                                <li>Sufficient capacity to carry small items such as books, driving
                                                    license, and other essentials.</li>
                                                <li>Water-resistant to lightly protect contents from rain and spills.
                                                </li>
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/32Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    ...
                                    <div class="row pt-2 pb-4">
                                        <div class="col-sm-6">
                                            ...
                                            <ul>
                                                ...
                                                <li>Design with Honda logo for better look</li>
                                                <li>Reinforced double stitching throughout the cover to ensure enhanced
                                                    durability and longer life.</li>
                                            </ul>
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/33Picture.png"
                                                alt="Reflector set (MIRROR)" style="width:60%; height:auto;">
                                        </div><br><br><br><br><br><br><br><br><br><br><br><br>
                                    </div>
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-4">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/jacket_front.png"-->
                                    <!--         alt="Jacket Front">-->
                                    <!--</div>-->
                                    <!--<div class="col-sm-4">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/jacket_back.png"-->
                                    <!--         alt="Jacket Back">-->
                                    <!--</div>-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture1.jpg"-->
                                    <!--         alt="Reflector set (MIRROR)" style="width:60%; height:auto;">-->
                                    <!--</div>-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture2.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture3.jpg"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture4.jpg"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/bikecover.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture6.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture7.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture8.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture10.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture11.png"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture12.jpg"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture13.jpg"-->
                                    ...
                                    <!--</div>-->
                                    <!--<div class="col-sm-6">-->
                                    <!--    <img src="<?= $this->Url->build('/', ['fullBase' => true]); ?>assets/public/images/accessory/Picture14.jpg"-->
