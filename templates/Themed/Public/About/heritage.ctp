<div class="" style="display:inline-block; width:100%;">
    ...
    <section class="micro-sec network-sec">
        <div class="network-header">
            <h1 style="text-align: center; margin-top: 0px; padding-bottom: 20px">Heritage</h1>
            <img src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_banner.jpg" alt="">
        </div>
        <div class="locator-sec">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h3 class="heritage_heading">40s & 50s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1949.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>First mass production of motorcycle begins</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1952.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1952</h4>
                        ...
                        <p>
                        <h4>Motorcycle export begins</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1954_01.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1954</h4>
                        ...
                        <p>
                        <h4>First entry into overseas race</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1954_02.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1954</h4>
                        ...
                        <p>
                        <h4>First Scooter Juno K-type is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1958.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1958</h4>
                        ...
                        <p>
                        <h4>Supercub C100 is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1959.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1959</h4>
                        ...
                        <p>
                        <h4>First entry in the Isle of Man TT Race</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">60s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1961.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1961</h4>
                        ...
                        <p>
                        <h4>First win at World Grand Prix</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1963.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1963</h4>
                        ...
                        <p>
                        <h4>First overseas production of motorcycles begins</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1969.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1969</h4>
                        ...
                        <p>
                        <h4>Dream CB750 Four is introduced</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">70s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_honda_logo.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1973</h4>
                        ...
                        <p>
                        <h4>Independent motorcycle R&D is established</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1973.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1973</h4>
                        ...
                        <p>
                        <h4>First production motocross model is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1974.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1974</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>Nigerian subsidiary  is established</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1979.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1979</h4>
                        ...
                        <p>
                        <h4>First Motocross World Championship victory</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">80s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1981.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1981</h4>
                        ...
                        <p>
                        <h4>Alcohol-fueled motorcycle is introduced in Brazil</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1982_01.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1982</h4>
                        ...
                        <p>
                        <h4>First Paris-Dakar Rally victory</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1982_02.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1982</h4>
                        ...
                        <p>
                        <h4>First adoption of electronic fuel injection for a motorcycle</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1982_03.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1982</h4>
                        ...
                        <p>
                        <h4>First World Trials Championship victory</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_milestone.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1987</h4>
                        ...
                        <p>
                        <h4>Cumulative motorcycle production reaches 50 million units</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">90s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1992.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1992</h4>
                        ...
                        <p>
                        <h4>CB900RR (Fireblade) is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1994.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1994</h4>
                        ...
                        <p>
                        <h4>Electric scooter is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>Cumulative motorcycle production reaches 100 million units</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_1998.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>1998</h4>
                        ...
                        <p>
                        <h4>First adoption of PGM-FI to a motorcycle</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">2000s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2005.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2005</h4>
                        ...
                        <p>
                        <h4>First introduction of motorcycle airbag system</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2008.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2008</h4>
                        ...
                        <p>
                        <h4>First introduction of combined ABS</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>Cumulative motorcycle production reaches 200 million units</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2009_01.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2009</h4>
                        ...
                        <p>
                        <h4>Flexible-fuel techonology is introduced</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2009_02.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2009</h4>
                        ...
                        <p>
                        <h4>Motorcycle Dual Clutch Transmission is introduced</h4>
                        </p>
                        <p>
                ...
                <p>&nbsp;</p>
                <h3 class="heritage_heading">2010s</h3>
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_honda_logo.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>Honda Motorcycle Kenya Limited is estblished</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>
                        <h4>Cumulative motorcycle production reaches 300 million units</h4>
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2014.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2014</h4>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <img class="img-responsive" src="<?php echo Router::url('/', true); ?>assets/public/images/about-us/heritage_2015.jpg">
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <p>
                        <h4>2015</h4>
                        ...
                        <p>
                        <h4>Honda reaches 700 WGP wins</h4>
                        </p>
                        <p>
