    ...
    <div id="carousel-example-generic" class="carousel slide home-slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item <?php if($count == 1) echo 'active' ?>">
                <a href="<?php echo $slider['Slider']['url']; ?>"><img
                        src="<?php echo Router::url('/', true).'assets/public/images/home-banner/'.$slider['Slider']['image']; ?>"
                        title="<?php if(isset($slider['Slider']['title'])){echo $slider['Slider']['title'];} ?>"
                        alt="<?php if(isset($slider['Slider']['title'])){echo $slider['Slider']['title'];} ?>" /></a>
            </div>
            <?php $count++; } ?>
        </div>
    </div>
                ...
                <div class="home-box box-slider latest-events">
                    ...
                    <div id="new-launch2" class="carousel slide" data-ride="carousel" data-interval="25000">
                        <div class="carousel-inner" role="listbox">
                            ...
                            <!--<div class="item">-->
                            <!--    <a href="<?php echo Router::url('/', true); ?>product/cb-shine-sp/index"><img src="<?php echo Router::url('/', true); ?>assets/public/images/gallery/rr_shine_sp.png" alt="CB Shine" style="width:100%; height:auto"></a>-->
                            <!--</div>-->
                            <div class="item">
                            ...
                            <!--<div class="item">-->
                            <!--    <a href="<?php echo Router::url('/', true); ?>product/cb-hornet-160r/index"><img src="<?php echo Router::url('/', true); ?>assets/public/images/gallery/rr_hornet.png" alt="Hornet Repsol" style="width:100%; height:auto"></a>-->
                            <!--</div>-->
                            <div class="item">
                            ...
                            <!--</div>-->
                            <!--<div class="item">-->
                            <!--    <a href="<?php echo Router::url('/', true); ?>product/livo/index"><img src="<?php echo Router::url('/', true); ?>assets/public/images/gallery/rr_livo.png" alt="Livo" style="width:100%; height:auto"></a>-->
                            <!--</div>-->
                            <!--<div class="item">-->
                            <!--    <a href="<?php echo Router::url('/', true); ?><product/sp-125/index"><img src="<?php echo Router::url('/', true); ?>assets/public/images/gallery/rr_sp125.png" alt="Unicorn" style="width:100%; height:auto"></a>-->
                            <!--</div>-->
                            <!--<div class="item">-->
                            <!--    <a href="<?php echo Router::url('/', true); ?>product/xblade/index"><img src="<?php echo Router::url('/', true); ?>assets/public/images/gallery/x1blade.jpg" alt="X blade" style="width:100%; height:auto"></a>-->
                            <!--</div>-->
                        </div>
                        <a class="left" href="#new-launch2" role="button" data-slide="prev">
                            <span><i class="fa fa-angle-left" aria-hidden="true"></i></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="right" href="#new-launch2" role="button" data-slide="next">
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 home-box-mobile">
                <div class="home-box map-box">
                    ...
                    <a href="<?php echo Router::url('/', true); ?>dealer-network/dealer-locator"><img
                            src="<?php echo Router::url('/', true); ?>assets/public/images/map1.jpg" alt="" /></a>
                </div>
            </div>
        </div>
    </section>
