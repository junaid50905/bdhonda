            ...
            <div class="col-md-12">
                <div id="exTab1" class="">
                    <ul class="nav nav-pills nab-tabs tabb-design" id="nav-tab" role="tablist">
                        <li id="li1" class="nav-link active" id="nav-helmet-tab" data-bs-toggle="tab" data-bs-target="#nav-helmet" type="button" role="tab" aria-controls="nav-helmet" aria-selected="true"><a href="#1a" data-toggle="tab">Helmet</a></li>
                        <li id="li2" class="nav-link" id="nav-front-pipe-tab" data-bs-toggle="tab" data-bs-target="#nav-front-pipe" type="button" role="tab" aria-controls="nav-front-pipe" aria-selected="true"><a href="#2a" data-toggle="tab">Front Pipe</a></li>
                        <li id="li3" class="nav-link" id="nav-liquid-item-tab" data-bs-toggle="tab" data-bs-target="#nav-liquid-item" type="button" role="tab" aria-controls="nav-liquid-item" aria-selected="true"><a href="#3a" data-toggle="tab">Liquid Item</a></li>
                        <li id="li4" class="nav-link" id="nav-other-tab" data-bs-toggle="tab" data-bs-target="#nav-other" type="button" role="tab" aria-controls="nav-other" aria-selected="true"><a href="#4a" data-toggle="tab">Other Items</a></li>
                    </ul>
                    <div class="tab-content p-3 border bg-light clearfix" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="nav-helmet" role="tabpanel" aria-labelledby="nav-helmet-tab">
                            <!--                            <div class="col-sm-12">-->
...
<!--                                                <img src="--><?php ////echo Router::url('/', true); 
                        ...
                        <div class="tab-pane fade" id="nav-front-pipe" role="tabpanel" aria-labelledby="nav-front-pipe-tab">
                            <div class="col-sm-12">
                                <div class="rightSidebarPro">
                        ...
                        <div class="tab-pane fade" id="nav-liquid-item" role="tabpanel" aria-labelledby="nav-liquid-item-tab">
                            <div class="col-sm-12">
                                <div class="rightSidebarPro">
